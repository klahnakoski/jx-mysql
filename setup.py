...
setup(
    ...
    install_requires=["jx-python==4.254.22317","mo-collections==5.252.22317","mo-dots==9.251.22317","mo-files==5.252.22317","mo-future==6.230.22310","mo-http==4.252.22317","mo-json==6.252.22317","mo-kwargs==7.252.22317","mo-logs==7.252.22317","mo-math==7.252.22317","mo-sql==4.252.22317","mo-times==5.252.22317","pymysql"],
    license='MPL 2.0',
